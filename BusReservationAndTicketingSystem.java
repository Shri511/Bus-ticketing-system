				...
				for (int x = 1; x == 1;) {
					...
					for (x = 1; x == 1;) {
						...
						if (choice.equals("1")) {
							...
							System.out.println("*****************************************");
							System.out.println("** 1.)Berhampur    |   Rs.12  |   " + available[1] + "   **");
							System.out.println("** 2.)Bhubaneswar  |   Rs.15  |   " + available[2] + "   **");
							System.out.println("** 3.)Chatrapur    |   Rs.12  |   " + available[3] + "   **");
							System.out.println("** 4.)Sambalpur    |   Rs.16  |   " + available[4] + "   **");
							System.out.println("** 5.)Koraput      |   Rs.18  |   " + available[5] + "   **");
							System.out.println("*****************************************");
							System.out.println("*****************************************\n");
							...
							if ((available[1] == 0) && (available[2] == 0) && (available[3] == 0) && (available[4] == 0)
								...
								String dest[] = { " ", "Berhampur", "Bhubaneswar", "Chatrapur", "Sambalpur",
										"Koraput" };
